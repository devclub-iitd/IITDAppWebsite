const events = [
    ...
    },
    {
        ...
        description:
            'The committee setup by the director for looking at various aspects pertaining to post lock down functioning of the Institute as well as the campus life has met few times and has made some recommendations. Faculty members may use their office as deemed appropriate keeping in mind the norms of hygiene and social distancing.',
        sourceName: 'ABP',
        author: 'Jaskeerat',
    ...
    },
    {
        ...
        description:
            'The entire world is coping with the global crisis of COVID-19. Social distancing and home confinement have emerged as the key to fight this pandemic. Evolution of a new culture is being experienced across the world. Agencies across the country are scuttling to limit the fatalities from COVID-19.',
        sourceName: 'ABP',
        author: 'Jaskeerat',
